...
class emp_roster(http.Controller):
    ...
    def update(self, type=None, department_id=None, employee_id=None,
               from_date=None, to_date=None,  **post):
        ...
        if int(employee_id) > 0:
            ...
            #                                  ('active', '=', True)],
            #                                 order='job_id desc')
            emp_list = employee_pool.search([('department_id', '=', department_id),
                                             ('active', '=', True)],
                                            order='job_id desc')
        else:
            # emp_list = employee_pool.search([('operating_unit_id', '=', operating_unit_id),
            ...
            emp_list = employee_pool.search([('active', '=', True)],
                                            order='department_id desc, job_id desc')
