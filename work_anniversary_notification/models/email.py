...
class ReminderVisa(models.Model):
    ...
    def work_anniversary_reminder(self):
        ...
        for i in employees:
            if i.initial_employment_date:
                daymonth = datetime.strptime(i.initial_employment_date, "%Y-%m-%d")
    ...
    def send_anniversary_notification(self, emp_id):
        ...
        template_id = self.env['ir.model.data'].get_object_reference('work_anniversary_notification',
                                                                     'work_anniversary_notification')[1]
