...
class StockReturnReport(models.AbstractModel):
    _name = 'report.stock_indent_return_report.report_stock_return'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('stock_indent_return_report.report_stock_return', docargs)
    ...
    def get_report_data(self, data):
        ...
        sql = '''SELECT ipl.product_id,
                 ...
                 FROM indent_return AS ii
                 LEFT JOIN indent_return_line AS ipl
                      ON ii.id = ipl.indent_return_id
