...
class RFQWizard(models.TransientModel):
    ...
    pr_ids = fields.Many2many('purchase.requisition', string='Purchase Requisition', default=lambda self: self.env.context.get('active_ids'))
    ...
    def action_save_rfq(self):
        ...
        rfq_name = self.env['ir.sequence'].next_by_code('purchase.rfq', date.today(), self.operating_unit_id) or '/'
...
class RFQProductLineWizard(models.TransientModel):
    ...
    _description = 'RFQ Product Line Wizard'
