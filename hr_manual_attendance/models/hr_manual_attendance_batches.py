...
class HrManualAttendance(models.Model):
    ...
    _description = "Hr Manual Attendance"
    _inherit = ['mail.thread']
    _description = "Hr Manual Attendance Batches"
    ...
    approbations_ids = fields.One2many('hr.employee.manual.att.approbation', 'manual_attandance_batches_id', string='Approvals', readonly=True)
    ...
    state = fields.Selection([
        ...
        ('refuse', 'Refused'),
        ('validate', 'Approved')
    ], string='Status', tracking=True, readonly=True, copy=False, default='draft',
