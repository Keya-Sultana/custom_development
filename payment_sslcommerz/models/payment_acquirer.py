...
class PaymentAcquirer(models.Model):
    ...
    def _sslcommerz_send_configuration_reminder(self):
        template = self.env.ref(
            'payment_sslcommerz.mail_template_sslcommerz_invite_user_to_configure', raise_if_not_found=False
        )
        if template:
    ...
    def _get_default_payment_method_id(self):
        ...
        return self.env.ref('payment_sslcommerz.payment_method_sslcommerz').id
